...
Scope: `**/qvac-registry-vcpkg/**`

- **Apply team standards:** Follow the shared coding standards in the root `CLAUDE.md` for code, scripts, documentation, and review findings wherever the standard applies.
